        ...
        private void OnRowClick(object sender, EventArgs e)
        {
            ...
            if (ri != null)
            {
                ...
                else if(menuItem.Caption == "행이동(↑)")
                {
                    ...
                    DataRow dr_Select = MainGrid.GetDataRow(iRow);
                    DataRow dr_Up = MainGrid.GetDataRow(iRow - 1);
                    ...
                    MainGrid.UnselectRow(iRow);
                    MainGrid.FocusedRowHandle = iRow - 1;
                    MainGrid.SelectRow(iRow - 1);
                }
                else if(menuItem.Caption == "행이동(↓)")
                {
                    ...
                    DataRow dr_Select = MainGrid.GetDataRow(iRow);
                    DataRow dr_Down = MainGrid.GetDataRow(iRow + 1);
