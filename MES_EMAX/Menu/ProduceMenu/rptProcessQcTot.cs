...
namespace MES
{
    public partial class rptProcessQcTot : BaseReg
    {
        ReturnStruct ret = new ReturnStruct();
        DataSet ds = new DataSet();

        public rptProcessQcTot()
        {
            InitializeComponent();
        }

        private void rptProcessQcTot_Load(object sender, EventArgs e)
        {
            //버튼 클릭 이벤트 선언
        ...
        private void Grid_Set()
        {
            ...
            DbHelp.GridSet(gc_MatQcM, gv_MatQcM, "Bad_Per", "불량율", "100", false, false, true);
            DbHelp.GridSet(gc_MatQcM, gv_MatQcM, "Con_Per", "특채율", "100", false, false, true);
            ...
            DbHelp.GridColumn_NumSet(gv_MatQcM, "Con_Per", 1);
        ...
        {
            SqlParam sp = new SqlParam("sp_rptProcessQcTot");
            sp.AddParam("Kind", "S");
            ...
            DbHelp.Footer_Set(gv_MatQcM, ForMat.SetDecimal(this.Name, "Qty1").NullString(), new string[] { "Good_Qty", "Bad_Qty", "Con_Qty" });
        }
