...
namespace MES
{
    public partial class rptBBOM : BaseReg
    {
        ...
        private void rptBBOM_Load(object sender, EventArgs e)
        {
            Grid_Set();
        ...
        private void Grid_Set()
        {
            ...
            SetUp_Tree.Tree_Columns_Set(treeList_Bom, "품목코드", "MItem_Code", 200, true);
            ...
            treeList_Bom.ImageIndexFieldName = "MItem_Code";
            treeList_Bom.StateImageList = imageCollection1;
        ...
        private void Item_Search_D(int iRow)
        {
            try
            {
                SqlParam sp = new SqlParam("sp_rptBBOM");
                sp.AddParam("Kind", "S");
