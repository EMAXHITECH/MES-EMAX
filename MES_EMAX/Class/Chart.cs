...
namespace MES
{
    public static class Chart
    {
        ...
        public static ChartControl Get_Chart(ChartControl chart, ViewType view_type, DataTable data, string arg, string val, string deciaml_length, string custom_text_ptrn)
        {
            d_length = deciaml_length;
            ...
            sr.Label.TextPattern = "{VP:P2} {A}   {V:N" + deciaml_length + "}"+ custom_text_ptrn;
