...
namespace MES
{
    public partial class BaseReg : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        protected void Menu_Jump(string Jump_Form, string Menu_Name, string sSearch_Key)
        {
           MainForm.Menu_Jump(Jump_Form, Menu_Name, sSearch_Key);
        }


        protected virtual void Control_TextChange(object sender, EventArgs e) { }

        public virtual void Search_Key(string sKey_No)
        {
            btn_Select.Focus();
