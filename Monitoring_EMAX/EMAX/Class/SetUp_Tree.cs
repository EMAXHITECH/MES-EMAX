...
namespace EMAX_Monitoring
{
    ...
    {
        public static void Tree_Columns_Set(TreeList treeList, string sCaption, string sFieldName, int iWidth, bool visible, bool Edit = false)
        {
            ...
            t_Column.OptionsColumn.FixedWidth = true;
